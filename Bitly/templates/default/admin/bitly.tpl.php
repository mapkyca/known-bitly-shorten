    ...
    <div class="col-md-10 col-md-offset-1">
        <form action="/admin/bitly/" class="form-horizontal" method="post">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="name" placeholder="Client ID" name="client_id" value="<?=htmlspecialchars(\Idno\Core\site()->config()->bitly['client_id'])?>" >
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="name">Client secret</label>
                <div class="controls">
                    <input type="text" id="name" placeholder="Client secret" name="client_secret" value="<?=htmlspecialchars(\Idno\Core\site()->config()->bitly['client_secret'])?>" >
                </div>
            </div>
	    <hr />
	    <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="name" placeholder="Generic Access Token" name="generic_access_token" value="<?=htmlspecialchars(\Idno\Core\site()->config()->bitly['generic_access_token'])?>" >
